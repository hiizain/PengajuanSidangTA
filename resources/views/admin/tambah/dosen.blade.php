...
<div class="">
    <div class="p-5">
        ...
        <div class="text-center">
            <h1 class="h4 text-gray-900 mb-4">Tambahkan Data Dosen!</h1>
        </div>
        <form action="/admin-dosen-create" method="post">
            @csrf
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user text-center" id="exampleFirstName"
                        placeholder="Nama Dosen" name="nama">
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
            ...
            <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                    <a href="/admin-dosen" class="btn btn-danger btn-user btn-block">
                        Batal
                    </a>
                </div>
                <div class="col-sm-6">
